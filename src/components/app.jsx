...
export const App = () => {
  ...
  const fetchNumberPeople = async () => {
    ...
    axios
      ...
      .catch((error) =>
        console.error(
          `There was an error retrieving the number of peoples: ${error}`
        )
      );
  };
  if (loading) return <p> table is loading...</p>;
    ...
    <div className="app">
      ...
      <Row className="col-12 m-0 p-0" style={{ height: "90vh" }}>
        <Switch>
          ...
          <Route path="/mainScreen">Main screen not yet implemented</Route>
          <Route>
